...
;return s.contains=s.contains.concat(t),c.contains=c.contains.concat(t),
    t=t.concat(s,c),{name:"Markdown",aliases:["md","mkdown","mkd"],contains:[{
        ...
        begin:"^[-\\*]{3,}",end:"$"},i,{begin:/^\[[^\n]+\]:/,returnBegin:!0,contains:[{
            ...
            className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("http",(()=>{"use strict";return e=>{
    ...
    var a,i="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",s={
        ...
        contains:[n.SHEBANG({binary:"ruby"})].concat(E).concat(t).concat(_)}}})());hljs.registerLanguage("erb",(()=>{"use strict";return e=>({name:"ERB",
    subLanguage:"xml",contains:[e.COMMENT("<%#","%>"),{begin:"<%[%=-]?",
        end:"[%-]?%>",subLanguage:"ruby",excludeBegin:!0,excludeEnd:!0}]})})());hljs.registerLanguage("haml",(()=>{"use strict";return e=>({name:"HAML",
...
;const l=r.inherit(r.TITLE_MODE,{begin:s}),d="(\\(.*\\)\\s*)?\\B[-=]>",g={
    ...
    name:"Shell Session",aliases:["console"],contains:[{className:"meta",
        begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#]/,starts:{end:/[^\\](?=\s*$)/,
            subLanguage:"bash"}}]})})());hljs.registerLanguage("yaml",(()=>{"use strict";return e=>{
